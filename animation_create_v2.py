...
# (НЕ НУЖНО) ВНИМАНИЕ!!! После завершения, вручную изменить интерполяцию кадров на линейную.

# Сюда вставить список ключевых кадров.
frames = [0, 11, 15, 19] # Heart
frames = [0, 2, 5, 11, 15, 19, 22] # MV
frames = [0, 5, 11, 15, 19, 22] # TV
frames = [0, 3, 6, 9, 10, 11, 12, 15, 17, 19] # PV
frames = [0, 3, 5, 6, 9, 11, 13, 15, 17, 19, 21, 23] # AV
